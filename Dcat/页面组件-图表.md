...
`Dcat Admin` 引入了 [apexcharts 图表](https://apexcharts.com/)功能，通过 `Dcat\Admin\Widgets\ApexCharts\Chart` 这个类可以帮助开发者快速渲染图表。

### 简单用法

如果你需要构建一个图表，可以参考下面的方式

> 更多类型的图表，请参考 [apexcharts 官方文档](https://apexcharts.com/)。
...
如果你需要在图表配置加入可执行的 JS 代码，可参考以下方式
